...
def read_genes_names(genes_file):
    '''
...
def check_genes(list_snp, gene_file):
    '''
...
def process_listcodon(lista_codon, new_codon, codon, my_aa, gene,lista_salida):
...
def process_listcodonN(lista_codon, new_codon, codon, my_aa, gene, lista_salida):
